...
def callback(msg):
    ...
    shape_pose.position.x = elbowx + ( cos(radians(msg.twist.angular.z+90-correction)) * sin(radians(msg.twist.angular.x+90)) * (0.5*shape.dimensions[0]-0.05))
    shape_pose.position.y = elbowy + ( sin(radians(msg.twist.angular.z+90-correction)) * sin(radians(msg.twist.angular.x+90)) * (0.5*shape.dimensions[0]-0.05))
